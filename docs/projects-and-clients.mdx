...
**Note**: A Time Tracking Event's calculated total time includes all **completed** segments. In other words, if you have a Time Tracking Event that's currently running, the total time displayed will not include the time spent on the current segment.
